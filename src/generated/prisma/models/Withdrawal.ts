...
export type WithdrawalOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "tokenAmount" | "feePercentage" | "netAmountIdr" | "status" | "approvedBy" | "paymentProviderRef" | "processedAt", ExtArgs["result"]["withdrawal"]>
...
export interface Prisma__WithdrawalClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  approver<T extends Prisma.Withdrawal$approverArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Withdrawal$approverArgs<ExtArgs>>): Prisma.Prisma__UserClient<runtime.Types.Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
  /**
